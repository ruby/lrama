  ...
  class OptionParser
    ...
    def parse_by_option_parser(argv)
      ::OptionParser.new do |o|
        ...
        o.on_tail '    pslr                             report PSLR split and scanner metrics'
    ...
    VALID_REPORTS = %i[states itemsets lookaheads solved counterexamples pslr rules terms verbose].freeze #: Array[Symbol]

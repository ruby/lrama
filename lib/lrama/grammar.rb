  ...
  class Grammar
    ...
    def validate_no_precedence_for_nterm!
      ...
      nterms.each do |nterm|
        ...
        errors << "[BUG] Precedence #{nterm.name} (line: #{nterm.precedence.lineno}) is defined for nonterminal (line: #{nterm.id.first_line}). Precedence can be defined for only terminal symbol."
      end

...
module Lrama
  class Report
    class States
      ...
      def self.report(states, io, itemsets: false, lookaheads: false, solved: false, counterexamples: false, verbose: false, **_)
        new(states, io).report(itemsets, lookaheads, solved, counterexamples, verbose)
      end
      ...
      # @rbs (bool itemsets, bool lookaheads, bool solved, bool counterexamples, bool verboses) -> void
      def report(itemsets, lookaheads, solved, counterexamples, verbose)
        if counterexamples

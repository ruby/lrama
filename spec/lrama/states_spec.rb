...
RSpec.describe Lrama::States do
  describe '#compute' do
    it "basic" do
      ...
      io = StringIO.new
      Lrama::Reporter.call(states, io, grammar: true, rules: true, terms: true, states: true, itemsets: true, lookaheads: true)
  ...
  describe '#reads_relation' do
    it do
      ...
      io = StringIO.new
      Lrama::Reporter.call(states, io, states: true, itemsets: true, verbose: true)
  ...
  describe '#compute_look_ahead_sets' do
    describe "state has 1 reduces and no transitions" do
      it "does not set look_ahead_sets" do
        ...
        io = StringIO.new
        Lrama::Reporter.call(states, io, states: true, lookaheads: true)
    ...
    describe "state has 1 reduces and no term transitions" do
      it "does not set look_ahead_sets" do
        ...
        io = StringIO.new
        Lrama::Reporter.call(states, io, states: true, lookaheads: true, itemsets: true)
  ...
  describe '#compute_conflicts' do
    describe "rules have no explicit precedence" do
      it "inherits precedence from the last term in RHS" do
        ...
        io = StringIO.new
        Lrama::Reporter.call(states, io, states: true, solved: true)
  ...
  describe '#compute_default_reduction' do
    it "selects a rule having most lookahead as default reduction rule" do
      ...
      io = StringIO.new
      Lrama::Reporter.call(states, io, states: true)

...
RSpec.describe Lrama::Parser do
  ...
  describe '#parse' do
    ...
    describe "%require" do
      it "can parse and show warning" do
        y = <<~INPUT
          %{
          // Prologue
          %}
        ...
        grammar.prepare
        grammar.validate!
        expect($stderr.string).to eq("%require is provided for compatibility with Bison and can be removed after migration to Lrama.\n")

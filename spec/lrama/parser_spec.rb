    ...
    char *str;
      ...
      expect(grammar.rules).to eq([
        ...
        Rule.new(
          ...
          code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " code 1 ")),
          nullable: false,
        ...
        Rule.new(
          ...
          rhs: [],
          code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " code 2 ")),
          nullable: true,
          precedence_sym: nil,
          lineno: 64,
        ),
        Rule.new(
          ...
          rhs: [],
          code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " code 3 ")),
          nullable: true,
          precedence_sym: nil,
          lineno: 64,
        ),
        ...
        Rule.new(
          ...
          rhs: [],
          code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " code 4 ")),
          nullable: true,
          precedence_sym: nil,
          lineno: 65,
        ),
        Rule.new(
          ...
          rhs: [],
          code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " code 5 ")),
          nullable: true,
          precedence_sym: nil,
          lineno: 65,
        ),
...
%%
          ...
          expect(grammar.rules).to eq([
            ...
            Rule.new(
              ...
              lhs: grammar.find_symbol_by_s_value!("@1"),
              rhs: [],
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $<i>1 = 1; $<i>$ = 2; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 17,
            ),
            Rule.new(
              ...
              lhs: grammar.find_symbol_by_s_value!("@2"),
              rhs: [],
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $<i>$ = 3; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 18,
            ),
            Rule.new(
              ...
              lhs: grammar.find_symbol_by_s_value!("$@3"),
              rhs: [],
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $<i>$ = 4; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 19,
            ),
            Rule.new(
              ...
              lhs: grammar.find_symbol_by_s_value!("$@4"),
              rhs: [],
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " 5; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 21,
            ),
            Rule.new(
              ...
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $<i>2; $<i>3; $<i>5; $<i>7; $<i>$ = 1; ")),
              nullable: false,
...
%%
          ...
          expect(grammar.rules).to eq([
            ...
            Rule.new(
              ...
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $$; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 17,
            ),
            ...
            Rule.new(
              ...
              code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " @0; ")),
              nullable: true,
              precedence_sym: nil,
              lineno: 21,
            ),
...
;
            ...
            expect(grammar.rules).to eq([
              ...
              Rule.new(
                ...
                code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $result = $left + $right; ")),
                nullable: false,
                precedence_sym: grammar.find_symbol_by_s_value!("'+'"),
                lineno: 24,
              ),
              Rule.new(
                ...
                code: Code::RuleAction.new(type: :rule_action, token_code: T::UserCode.new(s_value: " $$ = $1 - $2; ")),
                nullable: false,
                precedence_sym: grammar.find_symbol_by_s_value!("'-'"),
                lineno: 26,
              ),

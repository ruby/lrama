    ...
    describe "#enum_name" do
      describe "symbol is accept_symbol" do
        it "returns 'YYSYMBOL_YYACCEPT'" do
          sym = Lrama::Symbol.new(id: Token.new(Token::Ident, "$accept"))
      ...
      describe "symbol is eof_symbol" do
        it "returns 'YYSYMBOL_YYEOF'" do
          sym = Lrama::Symbol.new(id: Token.new(Token::Ident, "YYEOF"), alias_name: "\"end of file\"", token_id: 0)
          sym.number = 0
          sym.eof_symbol = true
      ...
      describe "symbol's token_id is less than 128" do
        it "returns 'YYSYMBOL_number_[alias_name_]'" do
          sym1 = Lrama::Symbol.new(id: Token.new(Token::Char, "'\\\\'"), alias_name: "\"backslash\"", token_id: 92, number: 70, term: true)
          sym2 = Lrama::Symbol.new(id: Token.new(Token::Char, "'.'"), alias_name: nil, token_id: 46, number: 69, term: true)
          sym3 = Lrama::Symbol.new(id: Token.new(Token::Char, "'\\n'"), alias_name: nil, token_id: 10, number: 162, term: true)
      ...
      describe "symbol includes $ or @" do
        it "returns 'YYSYMBOL_number_ref" do
          sym1 = Lrama::Symbol.new(id: Token.new(Token::Ident, "$@1"), token_id: -1, number: 165, term: false)
          sym2 = Lrama::Symbol.new(id: Token.new(Token::Ident, "@2"), token_id: -1, number: 166, term: false)
      ...
      describe "symbol's token_id is greater than 127" do
        it "returns 'YYSYMBOL_number_ref" do
          sym1 = Lrama::Symbol.new(id: Token.new(Token::Ident, "keyword_class"), alias_name: "\"`class'\"", token_id: 258, number: 3, term: true)
          sym2 = Lrama::Symbol.new(id: Token.new(Token::Ident, "top_compstmt"), token_id: 166, number: -1, term: false)
